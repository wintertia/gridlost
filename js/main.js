var Main = {
    ...
    proceedToNextStage: function() {
        ...
        State.player.chilled = 0;
        State.player.diseased = 0;
        State.player.cursed = 0;
        State.player.bleed = 0;
        State.player.poison = null;
        State.player.judgment = 0;
        State.player.berserk = 0;
        State.player.lifestealAura = 0;
        State.player.rejuvenation = 0;
        State.player.tempPowerTurns = 0;
        State.player.damageReduction = 0;
        State.player.damageReductionTurns = 0;
        State.burnTiles = [];
        State.poisonTiles = [];
        State.spikeTurns = 0;
        State.spikeLastX = -1;
